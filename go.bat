...
echo Linking...
g++ logic.o polygon.o triangle.o point.o run.o -o run.exe -L"SFML-2.6.0\lib" -lsfml-graphics-s -lsfml-window-s -lsfml-system-s -lwinmm -lopengl32 -lfreetype -lgdi32
del point.o
del polygon.o
del triangle.o
del logic.o
